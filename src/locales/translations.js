export const translations = {
  fr: {
    ...
    "hero.subtitle":
      "Une API gratuite, accessible à tous, pour créer un internet plus sûr et bienveillant.",
    "hero.btnStart": "Commencer →",
    "hero.btnDoc": "Accéder à l'API ",
    ...
    "guide.subtitle":
      "Découvrez comment intégrer et utiliser notre API pour détecter le hatespeech",
    "guide.step1Title": "Comprendre l'API",
    "guide.step1":
      "Notre API analyse les textes pour détecter le discours haineux, les insultes et le contenu toxique en temps réel.",
    "guide.step2Title": "Tester en Direct",
    "guide.step2":
      "Utilisez notre testeur d'API pour voir comment elle fonctionne. Envoyez un texte et obtenez une analyse instantanée.",
    "guide.step3Title": "Intégrer dans Votre App",
    "guide.step3":
      "Copiez simplement le code fourni et intégrez l'API dans votre application. Une seule requête suffit !",
    "guide.step4Title": "Modérer le Contenu",
    "guide.step4":
      "Utilisez les résultats pour modérer le contenu, protéger vos utilisateurs et créer une communauté bienveillante.",

    // API Tester
    "apiTester.title": "Testez l'API en Direct",
    "apiTester.subtitle":
      "Saisissez un texte et notre modèle d'IA analysera s'il contient du discours haineux.",
    ...
    "apiTester.errorURL":
      "❌ Erreur: Veuillez remplir l'URL et le point de terminaison",
    ...
    "apiInt.subtitle":
      "Utilisez notre détection de hatespeech en quelques lignes de code JavaScript",
    "apiInt.codeLabel": "Exemple de Code - JavaScript",
    "apiInt.copy": "Copier le Code",
    "apiInt.responseTitle": "Format de la Réponse",
    "apiInt.responseNote":
      "La confiance varie de 0.0 à 1.0. Définissez un seuil selon vos besoins.",

    // Articles
    "articles.title": "Articles et Ressources",
    "articles.subtitle":
      "Guides pratiques et articles pour promouvoir le bien-être et lutter contre le hatespeech",
    ...
    // Articles Content
    "articlesContent.article1.title":
      "Comprendre le Hatespeech : Définitions et Impacts",
    "articlesContent.article1.excerpt":
      "Le hatespeech englobe toute expression incitant à la discrimination ou la violence contre un groupe protégé.",
...
- Renforcement des divisions sociales`,
    ...
    "articlesContent.article2.title":
      "Gérer l'Anxiété Liée aux Réseaux Sociaux",
    "articlesContent.article2.excerpt":
      "L'exposition aux contenus toxiques peut générer du stress chronique. Découvrez des stratégies efficaces.",
...
5. **Consulter un professionnel** : Un psychologue peut offrir des outils adaptés`,
    ...
    "articlesContent.article3.title":
      "Dialogue Constructif : Comment Répondre au Cyberharcèlement",
    "articlesContent.article3.excerpt":
      "La communication non-violente est essentielle face aux attaques en ligne. Apprenez les bonnes pratiques.",
...
- **Signalez aux modérateurs** : Utilisez les outils de signalement`,
    ...
    "articlesContent.article4.title":
      "Pratiques de Bien-Être Digital : Cultiver un Environnement en Ligne Sain",
    "articlesContent.article4.excerpt":
      "Créez un espace numérique qui favorise votre bien-être mental et émotionnel.",
...
Si vous avez besoin de soutien, notre application Theramind offre des thérapies guidées et du soutien émotionnel 24/7.`,
    ...
    "support.subtitle":
      "Ressources et soutien pour ceux affectés par le hatespeech",
    "support.needHelp": "Besoin d'Aide?",
    "support.needHelpText":
      "Accédez à notre application Theramind, une compagne IA dédiée à votre bien-être psychologique et émotionnel. Thérapie guidée, ressources éducatives et soutien continu 24/7.",
    "support.accessTheramind": "Accéder à Theramind",
    "support.emergency": "Numéro d'Urgence",
    "support.emergencyText":
      "Si vous êtes en détresse immédiate, appelez une ligne d'aide professionnelle.",
    "support.community": "Communauté de Soutien",
    "support.communityText":
      "Rejoignez un forum sécurisé pour échanger avec d'autres utilisateurs, partager vos expériences et recevoir du soutien de pairs dans un environnement bienveillant et sans jugement.",
    ...
    "apiInt.fastTitle": "Rapide",
    "apiInt.fastDesc":
      "Réponse en moins de 200ms grâce à notre modèle optimisé.",
    "apiInt.freeTitle": "Gratuit",
    "apiInt.freeDesc":
      "Accès illimité à notre API sans frais, pour tous les développeurs.",
    "apiInt.secureTitle": "Confidentialité",
    "apiInt.secureDesc":
      "Les données ne sont pas sauvegardées et restent temporaires pour votre usage uniquement.",
  },
  en: {
    // Navigation
    "nav.guide": "Guide",
    ...
    "hero.subtitle":
      "A free API, accessible to everyone, to create a safer and more welcoming internet.",
    "hero.btnStart": "Get Started →",
    "hero.btnDoc": "Access the API",
    ...
    "guide.subtitle":
      "Discover how to integrate and use our API to detect hate speech",
    "guide.step1Title": "Understand the API",
    "guide.step1":
      "Our API analyzes text to detect hate speech, insults, and toxic content in real-time.",
    "guide.step2Title": "Test It Live",
    "guide.step2":
      "Use our API tester to see how it works. Send text and get instant analysis.",
    "guide.step3Title": "Integrate Into Your App",
    "guide.step3":
      "Simply copy the provided code and integrate the API into your application. One request is enough!",
    "guide.step4Title": "Moderate Content",
    "guide.step4":
      "Use the results to moderate content, protect your users, and build a welcoming community.",

    // API Tester
    "apiTester.title": "Test the API Live",
    "apiTester.subtitle":
      "Enter text and our AI model will analyze if it contains hate speech.",
    ...
    "apiInt.subtitle":
      "Use our hate speech detection in just a few lines of JavaScript code",
    "apiInt.codeLabel": "Code Example - JavaScript",
    "apiInt.copy": "Copy Code",
    "apiInt.responseTitle": "Response Format",
    "apiInt.responseNote":
      "Confidence varies from 0.0 to 1.0. Set a threshold according to your needs.",

    // Articles
    "articles.title": "Articles & Resources",
    "articles.subtitle":
      "Practical guides and articles to promote well-being and fight hate speech",
    ...
    // Articles Content
    "articlesContent.article1.title":
      "Understanding Hate Speech and Its Mental Health Impacts",
    "articlesContent.article1.excerpt":
      "How hate speech affects our mental well-being and how to cope with it.",
...
If you need support, our Theramind application offers guided therapy and emotional support 24/7.`,
    ...
    "articlesContent.article2.title":
      "Managing Anxiety Related to Social Media",
    "articlesContent.article2.excerpt":
      "Practical strategies to reduce stress caused by digital platforms.",
...
If anxiety persists despite these strategies, consult a mental health professional through platforms like Theramind.`,
    ...
    "articlesContent.article3.title":
      "Constructive Dialogue: Fighting Cyberbullying",
    "articlesContent.article3.excerpt":
      "How to engage in positive conversations and prevent online harassment.",
...
Teaching empathy and digital citizenship in schools and homes can prevent cyberbullying before it starts.`,
    ...
    "articlesContent.article4.title":
      "Digital Wellness Practices for a Healthy Balance",
    "articlesContent.article4.excerpt":
      "Creating a balanced relationship with technology for better mental health.",
...
If you need support, our Theramind application offers guided therapy and emotional support 24/7.`,
    ...
    "support.subtitle":
      "Resources and support for those affected by hate speech",
    "support.needHelp": "Need Help?",
    "support.needHelpText":
      "Access our Theramind application, an AI companion dedicated to your psychological and emotional well-being. Guided therapy, educational resources and continuous support 24/7.",
    "support.accessTheramind": "Access Theramind",
    "support.emergency": "Emergency Numbers",
    "support.emergencyText":
      "If you are in immediate distress, call a professional helpline.",
    "support.community": "Support Community",
    "support.communityText":
      "Join a secure forum to exchange with other users, share your experiences and receive peer support in a welcoming and judgment-free environment.",
    ...
    "footer.contact": "Contact",
    "apiInt.fastTitle": "Fast",
    "apiInt.fastDesc": "Response in under 200ms thanks to our optimized model.",
    "apiInt.freeTitle": "Free",
    "apiInt.freeDesc":
      "Unlimited access to our API at no cost, for all developers.",
    "apiInt.secureTitle": "Privacy",
    "apiInt.secureDesc":
      "Data is not stored and remains temporary for your use only.",
  },
  it: {
    // Navigation
    "nav.guide": "Guida",
    ...
    "hero.subtitle":
      "Un'API gratuita, accessibile a tutti, per creare un internet più sicuro e accogliente.",
    "hero.btnStart": "Inizia →",
    "hero.btnDoc": "Accedi all'API",
    ...
    "guide.subtitle":
      "Scopri come integrare e utilizzare la nostra API per rilevare il discorso d'odio",
    "guide.step1Title": "Comprendi l'API",
    "guide.step1":
      "La nostra API analizza il testo per rilevare i discorsi d'odio, gli insulti e i contenuti tossici in tempo reale.",
    "guide.step2Title": "Testalo Live",
    "guide.step2":
      "Usa il nostro tester API per vedere come funziona. Invia testo e ottieni analisi istantanea.",
    "guide.step3Title": "Integra nella Tua App",
    "guide.step3":
      "Copia semplicemente il codice fornito e integra l'API nella tua applicazione. Una sola richiesta è sufficiente!",
    "guide.step4Title": "Modera i Contenuti",
    "guide.step4":
      "Utilizza i risultati per moderare i contenuti, proteggere i tuoi utenti e costruire una comunità accogliente.",

    // API Tester
    "apiTester.title": "Testa l'API in Diretta",
    "apiTester.subtitle":
      "Inserisci un testo e il nostro modello AI analizzerà se contiene discorsi d'odio.",
    ...
    "apiInt.subtitle":
      "Utilizza il nostro rilevamento di discorsi d'odio in poche righe di codice JavaScript",
    "apiInt.codeLabel": "Esempio di Codice - JavaScript",
    "apiInt.copy": "Copia il Codice",
    "apiInt.responseTitle": "Formato della Risposta",
    "apiInt.responseNote":
      "La confidenza varia da 0,0 a 1,0. Imposta una soglia secondo le tue esigenze.",

    // Articles
    "articles.title": "Articoli e Risorse",
    "articles.subtitle":
      "Guide pratiche e articoli per promuovere il benessere e combattere il discorso d'odio",
    ...
    // Articles Content
    "articlesContent.article1.title":
      "Comprendere il Discorso d'Odio e i Suoi Impatti sulla Salute Mentale",
    "articlesContent.article1.excerpt":
      "Come il discorso d'odio influisce sul nostro benessere mentale e come affrontarlo.",
...
Se hai bisogno di supporto, la nostra applicazione Theramind offre terapia guidata e supporto emotivo 24/7.`,
    ...
    "articlesContent.article2.excerpt":
      "Strategie pratiche per ridurre lo stress causato dalle piattaforme digitali.",
...
Se l\'ansia persiste nonostante queste strategie, consultare un professionista della salute mentale tramite piattaforme come Theramind.`,
    ...
    "articlesContent.article3.title":
      "Dialogo Costruttivo: Combattere il Cyberbullismo",
    "articlesContent.article3.excerpt":
      "Come impegnarsi in conversazioni positive e prevenire le molestie online.",
...
Insegnare empatia e cittadinanza digitale a scuola e a casa può prevenire il cyberbullismo prima che inizi.`,
    ...
    "articlesContent.article4.title":
      "Pratiche di Benessere Digitale per un Equilibrio Sano",
    "articlesContent.article4.excerpt":
      "Creare una relazione equilibrata con la tecnologia per una migliore salute mentale.",
...
Se hai bisogno di supporto, la nostra applicazione Theramind offre terapia guidata e supporto emotivo 24/7.`,
    ...
    "support.subtitle":
      "Risorse e supporto per chi è stato colpito dal discorso d'odio",
    "support.needHelp": "Hai Bisogno di Aiuto?",
    "support.needHelpText":
      "Accedi alla nostra applicazione Theramind, un'AI companion dedicata al tuo benessere psicologico ed emotivo. Terapia guidata, risorse educative e supporto continuo 24/7.",
    "support.accessTheramind": "Accedi a Theramind",
    "support.emergency": "Numeri di Emergenza",
    "support.emergencyText":
      "Se sei in immediato disagio, contatta una linea di aiuto professionale.",
    "support.community": "Comunità di Supporto",
    "support.communityText":
      "Unisciti a un forum sicuro per scambiare con altri utenti, condividere le tue esperienze e ricevere supporto tra pari in un ambiente accogliente e senza giudizi.",
    ...
    "apiInt.fastTitle": "Veloce",
    "apiInt.fastDesc":
      "Risposta in meno di 200ms grazie al nostro modello ottimizzato.",
    "apiInt.freeTitle": "Gratuito",
    "apiInt.freeDesc":
      "Accesso illimitato alla nostra API senza costi, per tutti gli sviluppatori.",
    "apiInt.secureTitle": "Privacy",
    "apiInt.secureDesc":
      "I dati non vengono salvati e rimangono temporanei solo per il tuo utilizzo.",
  },
};
